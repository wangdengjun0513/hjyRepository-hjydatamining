...
public class TCustomerServiceImpl implements TCustomerService {
     ...
     */
    @Override
    public CommonResult insertSelective(TCustomer tCustomer, HttpServletRequest httpRequest) {
     ...
     */
    @Override
    public CommonResult updateById(TCustomer tCustomer, HttpServletRequest httpRequest) {
        SysToken sysToken = shiroService.findByToken(TokenUtil.getRequestToken(httpRequest));
