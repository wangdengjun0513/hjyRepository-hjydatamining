...
public interface TRecruitService {
     ...
     * @throws Exception
     */
    CommonResult insertSelective(TRecruit tRecruit, SysToken sysToken) throws Exception;
     ...
     * @throws Exception
     */
    CommonResult updateById(TRecruit tRecruit, SysToken sysToken) throws Exception;
